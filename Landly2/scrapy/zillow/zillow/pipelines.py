...
#class ZillowPipeline(object):
    ...
    #def process_item(self, item, spider):
        #line = json.dumps(dict(item),codecs.getwriter('utf-8')(self.file),sort_keys = True,indent = 4,ensure_ascii=False) + ',\n'
