...
class ApizillowItem(scrapy.Item):
...
class ApiItem(scrapy.Item):
    ...
    links = scrapy.Field() 
    FIPScounty = scrapy.Field() 
    useCode = scrapy.Field()    
    yearBuilt = scrapy.Field()
    taxAssessmentYear = scrapy.Field()
    taxAssessment = scrapy.Field()
    lotSizeSqFt = scrapy.Field()
    finishedSqFt = scrapy.Field()    
    bathrooms = scrapy.Field()
    bedrooms = scrapy.Field()    
    totalRooms = scrapy.Field()    
    lastSoldDate = scrapy.Field()
    lastSoldPrice = scrapy.Field()    
    zestimate = scrapy.Field()
    localRealEstate = scrapy.Field()
