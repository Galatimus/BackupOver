...
i = 0
l= open('../new.txt').read().splitlines()
dc = len(l)
page = l[i]
...
while True:
     ...
     class Domofond_Com(Spider):
	  def prepare(self):
	       self.link = 'https://www.trulia.com/CA/'+page.title().replace(' ','_')+'/'
	       self.lin = []
	       self.tobase = []	
	       self.dubl = []
