...
workbook = xlsxwriter.Workbook(u'0001-0013_00_У_001-0081_AYAX.xlsx')  
    

class Ayax_Zem(Spider):
     def prepare(self):
	  #self.f = page
	  self.ws = workbook.add_worksheet(u'Ayax_Земля')
     ...
     def task_post(self,grab,task):
	  ...
	  for elem in grab.doc.select(u'//div[@class="flex elem_row"]/a'):
...
time.sleep(5)
os.system("/home/oleg/pars/ayax/com.py")
