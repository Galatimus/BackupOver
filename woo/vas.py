...
class Cian_Zem(Spider):
     ...
     def task_generator(self):
	  for x in range(1,59):
               yield Task ('post',url='https://www.chinavasion.com/china/wholesale/computer-net/?page=%d'%x,refresh_cache=True,network_try_count=100)
	  for x1 in range(1,227):
	       yield Task ('post',url='https://www.chinavasion.com/china/wholesale/apparel-jewelry/?page=%d'%x1,refresh_cache=True,network_try_count=100)
	  for x2 in range(1,195):
	       yield Task ('post',url='https://www.chinavasion.com/china/wholesale/electronics/?page=%d'%x2,refresh_cache=True,network_try_count=100)     
...
bot.load_proxylist('/home/oleg/proxy/ivan.txt','text_file')
