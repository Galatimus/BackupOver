...
myProxy = random.choice(open('../tipa.txt').readlines())
print myProxy           
proxy = Proxy({'proxyType': ProxyType.MANUAL,'httpProxy': myProxy,'ftpProxy': myProxy,'sslProxy': myProxy})

profile =  webdriver.FirefoxProfile('/home/oleg/.mozilla/firefox/i272ly1q.default/')
...
class rebreakcaptcha(object):
    def __init__(self):
        ...
        self.driver = webdriver.Firefox(firefox_profile=profile,capabilities={"marionette": False},timeout=90)
