...
workbook = xlsxwriter.Workbook(u'0001-0013_00_У_001-0036_VRX-RU.xlsx')
...
class Cian_Zem(Spider):
     ...
     def task_generator(self):
	  for x in range(1,77):#49
               yield Task ('post',url='http://www.vrx.ru/data/prodazha/uchastki.html?pg=%d'% x)  
          yield Task ('post',url='http://www.vrx.ru/data/base.php?apptype=1&city=48&folds=5')
	  yield Task ('post',url='http://www.vrx.ru/data/arenda/uchastki.html')
...
time.sleep(5)
os.system("/home/oleg/pars/infoline/com.py")
