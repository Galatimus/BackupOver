...
workbook = xlsxwriter.Workbook(u'ar/Sochi_Domofond_a.xlsx') 
...
class Cian_Kv(Spider):
     ...
     def task_generator(self):
	  for x in range(1,58):#148
               yield Task ('post',url='http://www.domofond.ru/arenda-kvartiry-sochi-c909?RentalRate=Month&Page=%d'%x,network_try_count=100)
     ...
     def task_write(self,grab,task):
	  ...
	  self.ws.write(self.result, 10, u'DOMOFOND.RU')
