...
workbook = xlsxwriter.Workbook(u'Kinozal_Сериал_Буржуйский1.xlsx')
...
class Cian_Zem(Spider):
     ...
     def task_generator(self):
	  for x in range(71):#30
	       yield Task ('post',url= 'https://kinozal-tv.appspot.com/browse.php?c=46&v=1&w=11&page=%d'%x,network_try_count=100)
	  for x1 in range(20):#18   https://kinozal-tv.appspot.com/browse.php?c=46&d=1951&w=11
	       yield Task ('post',url='https://kinozal-tv.appspot.com/browse.php?c=46&w=7&page=%d'%x1,network_try_count=100)
	  for x2 in range(45):#18
	       yield Task ('post',url='https://kinozal-tv.appspot.com/browse.php?c=46&w=8&page=%d'%x2,network_try_count=100)         
	  for x3 in range(100):#18
	       yield Task ('post',url='https://kinozal-tv.appspot.com/browse.php?c=46&w=9&page=%d'%x3,network_try_count=100)                 
	  for x4 in range(100):#18
	       yield Task ('post',url='https://kinozal-tv.appspot.com/browse.php?c=46&w=10&page=%d'%x4,network_try_count=100)
	  for x in range(6):#30
	       yield Task ('post',url= 'https://kinozal-tv.appspot.com/browse.php?c=46&v=2&w=11&page=%d'%x,network_try_count=100)         
	  for x in range(100):#30
	       yield Task ('post',url= 'https://kinozal-tv.appspot.com/browse.php?c=46&v=3&w=11&page=%d'%x,network_try_count=100)                 
	  for x in range(6):#30
	       yield Task ('post',url= 'https://kinozal-tv.appspot.com/browse.php?c=46&v=4&w=11&page=%d'%x,network_try_count=100)        
	  for x in range(42):#30
	       yield Task ('post',url= 'https://kinozal-tv.appspot.com/browse.php?c=46&v=5&w=11&page=%d'%x,network_try_count=100)        
          yield Task ('post',url= 'https://kinozal-tv.appspot.com/browse.php?c=46&v=6&w=11',network_try_count=100) 
     ...
     def task_item(self, grab, task):
	  ...
	  try:
	       ...
	       plosh = ''
	  try:
	       vid = grab.doc.select(u'//b[contains(text(),"Перевод:")]/following-sibling::text()[1]').text()
	  except DataNotFound:
	       vid = '' 
	  #try:
