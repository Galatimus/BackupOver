...
while True:
     ...
     class Dmir_Kv(Spider):
          ...
          def prepare(self):
	       ...
	       while True:
		    try:
			 time.sleep(1)
			 g = Grab(timeout=2, connect_timeout=10)
			 ...
			 del g
			 continue	  	       
	       self.workbook = xlsxwriter.Workbook(u'Kv/Dmir_%s' % bot.sub + u'_Жилье_'+oper+'.xlsx')
     ...
     time.sleep(2)
     print('Save it...')    
     command = 'mount -t cifs //192.168.1.6/d /home/oleg/pars -o username=oleg,vers=1.0,password=1122,iocharset=utf8,file_mode=0777,dir_mode=0777' #'mount -a -O _netdev'
